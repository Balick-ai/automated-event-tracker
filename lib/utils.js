...
export const ATTEND_INLINE_COLORS = {
  going: { color: '#34d399', bg: 'rgba(52,211,153,0.15)' },
  maybe: { color: '#fbbf24', bg: 'rgba(251,191,36,0.15)' },
  undecided: { color: '#94a3b8', bg: 'rgba(148,163,184,0.15)' },
  'not going': { color: '#f87171', bg: 'rgba(248,113,113,0.15)' },
};

export const TICKET_INLINE_COLORS = {
  need: { color: '#fb923c', bg: 'rgba(251,146,60,0.15)' },
  have: { color: '#34d399', bg: 'rgba(52,211,153,0.15)' },
  'not needed': { color: '#94a3b8', bg: 'rgba(148,163,184,0.15)' },
};

export const SOURCE_LABELS = {
  manual: { label: 'Manual', color: '#94a3b8' },
  search: { label: 'Discovered', color: '#0ea5e9' },
  ticketmaster: { label: 'Ticketmaster', color: '#0ea5e9' },
  eventbrite: { label: 'Eventbrite', color: '#f97316' },
  edmtrain: { label: 'Edmtrain', color: '#10b981' },
  ai: { label: 'AI Search', color: '#a78bfa' },
};
